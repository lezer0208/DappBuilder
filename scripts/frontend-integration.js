 ...
 * This file demonstrates how to integrate Dappbuilder with a web frontend
 */

// For React/Vue/Angular applications
export class DappbuilderClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new DappbuilderClient(provider, contractAddress);
