...
const contractABI = require("../artifacts/contracts/Dappbuilder.sol/Dappbuilder.json").abi;

program
    .name("dappbuilder-cli")
    .description("CLI tool for Dappbuilder smart contract")
    .version("1.0.0");
